...
Sum7Spec1File = ROOT.TFile("/Users/vmgehman/Documents/CCDDevelopment/SpectroCCD/Images/2015-08-03/noClearXray1/noClearXray1_UnShuf.xrayAnalysis.root")
Sum7Spec2File = ROOT.TFile("/Users/vmgehman/Documents/CCDDevelopment/SpectroCCD/Images/2015-08-03/noClearXray2/noClearXray2_UnShuf.xrayAnalysis.root")
Sum7Spec3File = ROOT.TFile("/Users/vmgehman/Documents/CCDDevelopment/SpectroCCD/Images/2015-08-03/noClearXray3/noClearXray3_UnShuf.xrayAnalysis.root")
Sum7Spec4File = ROOT.TFile("/Users/vmgehman/Documents/CCDDevelopment/SpectroCCD/Images/2015-08-03/noClearXray4/noClearXray4_UnShuf.xrayAnalysis.root")
Sum7Spec1 = Sum7Spec1File.Get("PixValHisto_Sum7")
Sum7Spec1.SetLineColor(ROOT.kBlack)
Sum7Spec2 = Sum7Spec2File.Get("PixValHisto_Sum7")
Sum7Spec2.SetLineColor(ROOT.kBlue)
Sum7Spec3 = Sum7Spec3File.Get("PixValHisto_Sum7")
Sum7Spec3.SetLineColor(ROOT.kGreen - 1)
Sum7Spec4 = Sum7Spec4File.Get("PixValHisto_Sum7")
Sum7Spec4.SetLineColor(ROOT.kRed)
# Rebin these puppies because they're kind of noisy...
RebinFactor = 5
for spectrum in [Sum7Spec1, Sum7Spec2, Sum7Spec3, Sum7Spec4]:
...
EnResLegend.SetFillColor(ROOT.kWhite)
EnResLegend.SetTextFont(42)
EnResLegend.AddEntry(Sum7Spec1, "Image 1", "l")
EnResLegend.AddEntry(Sum7Spec2, "Image 2", "l")
EnResLegend.AddEntry(Sum7Spec3, "Image 3", "l")
EnResLegend.AddEntry(Sum7Spec4, "Image 4", "l")
EnResLegend.Draw()
aCanvas.Update()
aCanvas.SaveAs("./Sum7Spectra.pdf")
