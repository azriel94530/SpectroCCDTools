...
RootFiles = []
RootFiles.append(ROOT.TFile("/Users/vmgehman/Documents/CCDDevelopment/SpectroCCD/Images/2015-08-19/GoodDarkImage1/GoodDarkImage1_UnShuf.DarkNoise.PixelValues.root"))
RootFiles.append(ROOT.TFile("/Users/vmgehman/Documents/CCDDevelopment/SpectroCCD/Images/2015-08-19/GoodDarkImage2/GoodDarkImage2_UnShuf.DarkNoise.PixelValues.root"))
RootFiles.append(ROOT.TFile("/Users/vmgehman/Documents/CCDDevelopment/SpectroCCD/Images/2015-08-19/GoodDarkImage3/GoodDarkImage3_UnShuf.DarkNoise.PixelValues.root"))
...
FitModels = []
for pvh in PixValHistos:
  FitModels.append(PythonTools.GetOneGausFitModel("FitModel_" + pvh.GetTitle().split(" ")[-1], pvh, 0., 50.))

# Actually do the fit and save the plot.
for i in range(len(PixValHistos)):
  PixValHistos[i].Fit(FitModels[i], "QLLEM", "", -400., 50.)
aCanvas.Update()
OutputPlotName = "/Users/vmgehman/Documents/CCDDevelopment/SpectroCCD/Images/2015-08-19/DarkFrameValues.pdf"
