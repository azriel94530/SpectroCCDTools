...
#define XPAR_ETHERNET_PHY_TYPE 3
...
#define XPAR_MCB_DDR2_MEM_ADDR_WIDTH 14
...
/* Definitions for peripheral MCB_DDR2 */
#define XPAR_MCB_DDR2_S0_AXI_BASEADDR 0xB0000000
#define XPAR_MCB_DDR2_S0_AXI_HIGHADDR 0xBFFFFFFF
...
#define XPAR_RS232_0_BASEADDR 0x40600000
#define XPAR_RS232_0_HIGHADDR 0x4060FFFF
#define XPAR_RS232_0_DEVICE_ID 1
#define XPAR_RS232_0_BAUDRATE 115200
#define XPAR_RS232_0_USE_PARITY 0
#define XPAR_RS232_0_ODD_PARITY 1
...
#define XPAR_UARTLITE_1_DEVICE_ID XPAR_RS232_0_DEVICE_ID
...
/* Definitions for peripheral SPI_CLK */
#define XPAR_SPI_CLK_DEVICE_ID 0
#define XPAR_SPI_CLK_BASEADDR 0x40A80000
#define XPAR_SPI_CLK_HIGHADDR 0x40A8FFFF
#define XPAR_SPI_CLK_FIFO_EXIST 1
#define XPAR_SPI_CLK_SPI_SLAVE_ONLY 0
#define XPAR_SPI_CLK_NUM_SS_BITS 1
#define XPAR_SPI_CLK_NUM_TRANSFER_BITS 16
#define XPAR_SPI_CLK_SPI_MODE 0
...
/* Definitions for peripheral SPI_VIDEO1 */
#define XPAR_SPI_VIDEO1_DEVICE_ID 2
#define XPAR_SPI_VIDEO1_BASEADDR 0x40A40000
#define XPAR_SPI_VIDEO1_HIGHADDR 0x40A4FFFF
#define XPAR_SPI_VIDEO1_FIFO_EXIST 1
#define XPAR_SPI_VIDEO1_SPI_SLAVE_ONLY 0
#define XPAR_SPI_VIDEO1_NUM_SS_BITS 1
#define XPAR_SPI_VIDEO1_NUM_TRANSFER_BITS 16
#define XPAR_SPI_VIDEO1_SPI_MODE 0


/******************************************************************/

/* Canonical definitions for peripheral SPI_CLK */
#define XPAR_SPI_0_DEVICE_ID XPAR_SPI_CLK_DEVICE_ID
#define XPAR_SPI_0_BASEADDR 0x40A80000
#define XPAR_SPI_0_HIGHADDR 0x40A8FFFF
...
#define XPAR_SPI_1_DEVICE_ID XPAR_SPI_FLASH_DEVICE_ID
...
/* Canonical definitions for peripheral SPI_VIDEO1 */
#define XPAR_SPI_2_DEVICE_ID XPAR_SPI_VIDEO1_DEVICE_ID
#define XPAR_SPI_2_BASEADDR 0x40A40000
#define XPAR_SPI_2_HIGHADDR 0x40A4FFFF
...
#define XPAR_AXI_TIMER_0_BASEADDR 0x20000000
#define XPAR_AXI_TIMER_0_HIGHADDR 0x20000FFF
...
#define XPAR_TMRCTR_0_BASEADDR 0x20000000
#define XPAR_TMRCTR_0_HIGHADDR 0x20000FFF
#define XPAR_TMRCTR_0_CLOCK_FREQ_HZ XPAR_AXI_TIMER_0_CLOCK_FREQ_HZ

/******************************************************************/


/* Definitions for peripheral CCD_STATE_0 */
#define XPAR_CCD_STATE_0_BASEADDR 0x74200000
#define XPAR_CCD_STATE_0_HIGHADDR 0x7420FFFF
...
/* Definitions for peripheral VIDEO_BRAM_CTRL */
#define XPAR_VIDEO_BRAM_CTRL_DEVICE_ID 2
#define XPAR_VIDEO_BRAM_CTRL_DATA_WIDTH 32
#define XPAR_VIDEO_BRAM_CTRL_ECC 0
#define XPAR_VIDEO_BRAM_CTRL_FAULT_INJECT 0
#define XPAR_VIDEO_BRAM_CTRL_CE_FAILING_REGISTERS 0
#define XPAR_VIDEO_BRAM_CTRL_UE_FAILING_REGISTERS 0
#define XPAR_VIDEO_BRAM_CTRL_ECC_STATUS_REGISTERS 0
#define XPAR_VIDEO_BRAM_CTRL_CE_COUNTER_WIDTH 0
#define XPAR_VIDEO_BRAM_CTRL_ECC_ONOFF_REGISTER 0
#define XPAR_VIDEO_BRAM_CTRL_ECC_ONOFF_RESET_VALUE 1
#define XPAR_VIDEO_BRAM_CTRL_WRITE_ACCESS 0
#define XPAR_VIDEO_BRAM_CTRL_S_AXI_BASEADDR 0xA1000000
#define XPAR_VIDEO_BRAM_CTRL_S_AXI_HIGHADDR 0xA1003FFF


/* Definitions for peripheral WAVEFORM_BRAM_CTRL */
#define XPAR_WAVEFORM_BRAM_CTRL_DEVICE_ID 3
#define XPAR_WAVEFORM_BRAM_CTRL_DATA_WIDTH 32
#define XPAR_WAVEFORM_BRAM_CTRL_ECC 0
#define XPAR_WAVEFORM_BRAM_CTRL_FAULT_INJECT 0
#define XPAR_WAVEFORM_BRAM_CTRL_CE_FAILING_REGISTERS 0
#define XPAR_WAVEFORM_BRAM_CTRL_UE_FAILING_REGISTERS 0
#define XPAR_WAVEFORM_BRAM_CTRL_ECC_STATUS_REGISTERS 0
#define XPAR_WAVEFORM_BRAM_CTRL_CE_COUNTER_WIDTH 0
#define XPAR_WAVEFORM_BRAM_CTRL_ECC_ONOFF_REGISTER 0
#define XPAR_WAVEFORM_BRAM_CTRL_ECC_ONOFF_RESET_VALUE 1
#define XPAR_WAVEFORM_BRAM_CTRL_WRITE_ACCESS 0
#define XPAR_WAVEFORM_BRAM_CTRL_S_AXI_BASEADDR 0xA0000000
#define XPAR_WAVEFORM_BRAM_CTRL_S_AXI_HIGHADDR 0xA0000FFF
...
/* Canonical definitions for peripheral VIDEO_BRAM_CTRL */
#define XPAR_BRAM_2_DEVICE_ID XPAR_VIDEO_BRAM_CTRL_DEVICE_ID
...
#define XPAR_BRAM_2_BASEADDR 0xA1000000
#define XPAR_BRAM_2_HIGHADDR 0xA1003FFF

/* Canonical definitions for peripheral WAVEFORM_BRAM_CTRL */
#define XPAR_BRAM_3_DEVICE_ID XPAR_WAVEFORM_BRAM_CTRL_DEVICE_ID
...
#define XPAR_BRAM_3_BASEADDR 0xA0000000
#define XPAR_BRAM_3_HIGHADDR 0xA0000FFF
...
#define XPAR_MICROBLAZE_0_INTC_KIND_OF_INTR 0xFFFFFFC8
...
#define XPAR_RS232_0_INTERRUPT_MASK 0X000008
#define XPAR_MICROBLAZE_0_INTC_RS232_0_INTERRUPT_INTR 3
#define XPAR_ETHERNET_INTERRUPT_MASK 0X000010
#define XPAR_MICROBLAZE_0_INTC_ETHERNET_INTERRUPT_INTR 4
#define XPAR_IIC_0_IIC2INTC_IRPT_MASK 0X000020
#define XPAR_MICROBLAZE_0_INTC_IIC_0_IIC2INTC_IRPT_INTR 5
...
#define XPAR_INTC_0_UARTLITE_1_VEC_ID XPAR_MICROBLAZE_0_INTC_RS232_0_INTERRUPT_INTR
#define XPAR_INTC_0_AXIETHERNET_0_VEC_ID XPAR_MICROBLAZE_0_INTC_ETHERNET_INTERRUPT_INTR
#define XPAR_INTC_0_IIC_0_VEC_ID XPAR_MICROBLAZE_0_INTC_IIC_0_IIC2INTC_IRPT_INTR
