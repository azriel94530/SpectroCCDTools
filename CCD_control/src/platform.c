...
void platform_setup_interrupts()
{
	...
	Xil_ExceptionRegisterHandler(XIL_EXCEPTION_ID_INT,
				...
				intcp);
	//register the IIC interrupt. not sure why this is different. see if this works...
	XIntc_Connect(intcp, IIC_INTR_ID,
				       (XInterruptHandler) XIic_InterruptHandler,
				       &IicInstance);
	XIntc_Enable(intcp, IIC_INTR_ID);
...
//set up interrupts
    ...
    //config IIC: Set the Transmit and Receive handlers
